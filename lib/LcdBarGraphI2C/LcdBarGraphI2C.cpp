/**
 * File: LcdBarGraphI2C.cpp
 * Description:
 * LcdBarGraphI2C is an Arduino library for displaying analog values in LiquidCrystal_I2C display, 
 *   which is previously initialized. This library uses LiquidCrystal_I2C library (https://bitbucket.org/fmalpartida/new-liquidcrystal/wiki/Home) for displaying.
 *
 ...
 * Copying permission statement:
    This file is part of LcdBarGraphI2C.

    LcdBarGraphI2C is free software: you can redistribute it and/or modify
...
// -- constructor
LcdBarGraphI2C::LcdBarGraphI2C(LiquidCrystal_I2C* lcd, byte numCols, byte startX, byte startY)
{
    // -- setting fields
    _lcd = lcd;
    _numCols = numCols;
...
// -- the draw function
void LcdBarGraphI2C::drawValue(int value, int maxValue) {
